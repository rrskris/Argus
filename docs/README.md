...
Start with the [project README](../README.md) for what Argus is and the
...
| [ci-integration.md](ci-integration.md) | The headless CLI, `argus.yaml` risk-context-as-code, exit-code gating, GitHub Actions / GitLab / Jenkins / Argo CD recipes |
